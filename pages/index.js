    ...
    return (
      hasMetamask ?
        (<div className='flex flex-col justify-center items-center  w-screen h-screen  bg-gradient-to-r from-cyan-500 to-purple-300 space-y-8'>
          ...
          <button onClick={() => connect()} type="button" className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 ">
  ...
  return (
    <>
      <main>
        <Header />
        {/* <Content /> */}
        <div className='p-10 sm'>
          <div className='p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14'>
            <div className="flex items-center justify-center h-auto mb-3 rounded bg-gray-50 dark:bg-gray-800">
        ...
        {/* <Tabs className='mt-10' size='lg' colorScheme='purple' align='center' variant='enclosed'>
          <TabList>
